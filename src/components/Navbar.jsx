      ...
      <div className="max-w-6xl mx-auto px-5 py-3.5 min-h-18 flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center whitespace-nowrap gap-2" aria-label="Primary navigation">
          ...
          <div className="relative">
            ...
            {trainingOpen && (
              <div className="absolute right-0 top-full z-50 pt-3 w-56">
                <div className="rounded-2xl bg-white border border-slate-200 shadow-xl py-2 ring-1 ring-slate-900/5">
                  ...
                  <NavLink to="/training#employees" onClick={() => setTrainingOpen(false)} className="block px-4 py-2.5 text-sm text-slate-700 hover:bg-orange-50 hover:text-orange-600">Employee Development</NavLink>
                </div>
              </div>
            )}
          </div>
            ...
            <div className="py-2">
              ...
              {trainingOpen && (
                <div className="pl-4">
                  ...
                  <Link to="/training#employees" onClick={() => { setOpen(false); setTrainingOpen(false) }} className="block py-2 text-white/80 hover:text-orange-400">Employee Development</Link>
                </div>
              )}
            </div>

            <div className="py-2">
              <Link to="/hiring" onClick={() => { setOpen(false); setHiringOpen(false) }} className="block py-2 text-white/95 hover:text-orange-400">Hiring & Selection</Link>
            </div>
