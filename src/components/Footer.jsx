    ...
    <footer className="bg-primary-900 text-white mt-12">
      <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-start justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="font-semibold">TalenTiT Hospitality</div>
      ...
      <div className="text-center text-white/60 text-sm py-4">© {new Date().getFullYear()} TalenTiT Hospitality. All rights reserved.</div>
    </footer>
  )
}
