...
export default function SupportTeam() {
  return (
    ...
    >
      ...
      <div className="relative site-container site-section-compact">
        <SectionHeader
          eyebrow="Support Team"
          title="Meet Our Support Team"
          description="Supporting recruitment, contracts, digital operations and technology-driven service delivery."
          centered
        />

        <div className="section-content grid md:grid-cols-2 gap-5 sm:gap-6 max-w-3xl mx-auto">
          {teamMembers.map((member) => (
            <article
              key={member.name}
              className="group flex h-full flex-col rounded-3xl bg-white border border-orange-100 px-6 py-7 text-center shadow-md shadow-[#04172f]/5 transition-all duration-200 ease-out hover:-translate-y-0.5 hover:border-[#ea580c]/40 hover:shadow-lg hover:shadow-[#04172f]/8"
            >
