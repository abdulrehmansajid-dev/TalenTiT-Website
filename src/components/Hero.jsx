...
export default function Hero() {
  ...
  return (
    <section id="home" className="pt-20 pb-14 sm:pb-16 min-h-[78vh] flex items-center text-white bg-hero relative overflow-hidden" style={{ backgroundImage: `linear-gradient(120deg, rgba(2, 9, 25, 0.82) 0%, rgba(7, 37, 75, 0.78) 50%, rgba(211, 84, 0, 0.28) 100%), url(${bg})` }}>
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 relative z-10 w-full">
        <div className="max-w-3xl fade-in-up">
          ...
          <div className="mt-8 flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-5">
            <a href="#services" className="inline-flex w-full sm:w-auto justify-center items-center px-6 py-3 bg-white text-primary-900 rounded-full font-semibold hover:bg-slate-100 transition">Other Services</a>
            <a href="#roles" className="inline-flex w-full sm:w-auto justify-center items-center px-6 py-3 bg-accent-600 text-white rounded-full font-semibold hover:bg-accent-700 transition">Open Roles</a>
            <a href="#contact" className="inline-flex w-full sm:w-auto justify-center items-center px-6 py-3 border border-white/30 text-white rounded-full hover:bg-white/10 transition">Contact Us</a>
          </div>
        </div>
      </div>
    </section>
