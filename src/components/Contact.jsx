      ...
      <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-8">
        <div className="rounded-2xl p-7 md:p-8 bg-primary-900 text-white border border-primary-800">
          ...
          <div className="mt-6 rounded-2xl bg-white/8 border border-white/10 p-5">
            ...
            <p className="text-white/82 mt-2 leading-7">Training, HR Outsourcing, Talent Acquisition, Quality Assurance, and bespoke L&D solutions for hospitality.</p>
          </div>
        </div>
        ...
        <div className="rounded-2xl p-7 md:p-8 bg-white border border-slate-200 shadow-sm">
          <form ref={form} onSubmit={sendEmail} className="grid gap-4">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              {status === 'SENT' && <span className="text-slate-800 font-medium">Message sent. Thank you!</span>}
