...
export default function About() {
  return (
    <section id="about" className="py-20 relative overflow-hidden">
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(2,9,25,0.05),rgba(211,84,0,0.08))]" />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-slate-800 text-lg leading-8 max-w-3xl">We are training and HR consultants specialized in hospitality industry training, talent acquisition and talent management solutions. Our team brings decades of experience working with top hospitality brands across the GCC.</p>
        </div>
        ...
        <div className="mt-10 grid lg:grid-cols-[280px_1fr] gap-6 items-center rounded-[2rem] p-6 md:p-8 bg-white/90 border border-slate-200 shadow-2xl shadow-primary-950/5 backdrop-blur">
          ...
          <div>
            ...
            <p className="text-gray-700 mt-3 leading-7 max-w-2xl">A Master Degree holder in HRM with two decades of experience heading HR and training departments for top hospitality brands including Hyatt, Ritz Carlton, IHG, Radisson Blu and Millennium Hotels across the GCC. Certified hospitality trainer and award winner in HR and training.</p>
          </div>
        </div>

        <div className="mt-8 grid md:grid-cols-3 gap-6">
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-lg shadow-primary-950/5">
